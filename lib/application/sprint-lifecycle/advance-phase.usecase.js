 ...
 * @param {{ gateEvaluator?: function, eventEmitter?: function, clock?: () => string, allowGateOverride?: boolean, approve?: boolean, reason?: string }} [deps]
 * @returns {Promise<{ ok: boolean, sprint?: import('../../domain/sprint/entity').Sprint, event?: Object, gateResults?: Object, reason?: string, stopAfter?: string, hint?: string, approvalRecord?: Object }>}
 */
